...
Some challenges I went through were:
- Implementing changes to the database when deleting items from the Recyclerview
- Getting a conceptual understanding of the Room persistence library and SQLite queries
